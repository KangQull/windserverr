...
case $choice in
    ...
    6)
        ...
        iso_link="http://15.235.200.203/19044.1288.211006-0501.21h2_release_svc_refresh_CLIENT_LTSC_EVAL_x64FRE_en-us.iso"
    ...
    13)
        ...
        iso_link="http://15.235.200.203/en_windows_11_x64.ISO"
